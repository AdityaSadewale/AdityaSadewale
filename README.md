# 👋 Hi, I'm Aditya Sadewale<br><br>🚀 Full-Stack & AI Developer | Python | MERN Stack | Web & Automation 🎯 Passionate about building AI-powered applications and real-world automation tools.<br><br>📧 Email: adityasadewale@gmail.com

💻 Full-Stack & AI Developer with expertise in Python, MERN Stack, and web development. Skilled in building AI-powered applications, automation tools, and responsive web interfaces. Experienced in backend & frontend development, databases (MongoDB/MySQL), REST APIs, and cloud integration. Passionate about solving real-world problems through technology, AI, and automation.

## 🌐 Socials:
LinkedIn https: //www.linkedin.com/in/aditya-sadewale-760359318
...
<ul>
  <li>
    <strong>Generative AI Studio Certification</strong> – Demonstrates knowledge of generative AI tools and AI-based application development.
  </li>
  <li>
    <strong>Introduction to Artificial Intelligence</strong> – Completed via <em>Great Learning</em>, covering AI fundamentals, machine learning basics, and real-world applications.
  </li>
  <li>
    <strong>HTML & CSS Development Certification (2024)</strong> – From <em>STP Computer Education</em>, focusing on responsive web design and frontend development fundamentals.
  </li>
  <li>
    <strong>Computer Ethics in AI</strong> – Certification from <em>Microsoft</em> in collaboration with <em>LinkedIn</em>, covering ethical AI usage, responsible AI development, and data privacy.
  </li>
  <li>
    <strong>AI for Entrepreneurship</strong> – Course focused on using AI technologies for business innovation, automation, and startup solutions.
  </li>
</ul>
